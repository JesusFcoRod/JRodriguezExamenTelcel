...
namespace AccesoDatos
{
    ...
    public partial class JRodriguezExamenPracticoTelcelEntities : DbContext
    {
        public JRodriguezExamenPracticoTelcelEntities()
            : base("name=JRodriguezExamenPracticoTelcelEntities")
        {
        }
